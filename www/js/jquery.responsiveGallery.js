;(function($){
	fadeTo=()=>{
		for(let i = 0; i < $(".responsiveGallery-item").length; i++){
			if($(".responsiveGallery-item")[i].style.transform == 'translateX(300%) translateZ(-200px) rotateY(-45deg)'
			|| $(".responsiveGallery-item")[i].style.transform == 'translateX(100%) translateZ(-200px) rotateY(45deg)'
			|| $(".responsiveGallery-item")[i].style.transform == 'translateX(200%) translateZ(-300px) rotateY(-45deg)'){
				$(".responsiveGallery-item")[i].style.opacity = 0.7
			}
			if($(".responsiveGallery-item")[i].style.transform == 'translateX(0px) translateZ(-300px) rotateY(45deg)'
			|| $(".responsiveGallery-item")[i].style.transform == 'translateX(400%) translateZ(-300px) rotateY(-45deg)'){
				$(".responsiveGallery-item")[i].style.opacity = 0.3
			}
		}
	}
	loadPage=()=>{
	...
	$("#toTop").click(function () {
	 ...
	 $(window).scroll(function() {
		 ...
		 {
			$('div.invisible').fadeIn(3000).removeClass('invisible');
		}else{
